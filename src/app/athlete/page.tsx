    ...
    return (
        <div className='bg-white w-full h-screen'>
            ...
            <div className="relative bg-gradient-to-r from-purple-900 to-blue-900 h-32 flex items-center justify-center shadow-xl">
                ...
                <button onClick={() => router.push('/')} className="absolute right-6 font-roboto font-medium text-lg flex text-center bg-white text-blue-900 px-6 py-3 rounded-lg hover:opacity-90 transition-opacity shadow-lg">Home</button>
            </div>
