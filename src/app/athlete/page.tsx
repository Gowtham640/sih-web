        ...
        <div className='bg-white w-full h-screen'>
            ...
            <div className="relative bg-gradient-to-r from-purple-900 to-blue-900 h-32 flex items-center justify-center shadow-xl">
                ...
                <div className="absolute right-6 flex gap-2">
                    <button onClick={handleLogout} className="font-roboto font-medium text-lg flex text-center bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors shadow-lg">Logout</button>
                    <button onClick={() => router.push('/')} className="font-roboto font-medium text-lg flex text-center bg-white text-blue-900 px-6 py-3 rounded-lg hover:opacity-90 transition-opacity shadow-lg">Home</button>
                </div>
            </div>
