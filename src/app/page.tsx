    ...
    <div className="bg-white w-full h-screen">
      ...
      <div className="relative bg-gradient-to-r from-purple-900 to-blue-900 h-32 flex items-center justify-center shadow-xl">
        ...
        <div className="absolute right-6 flex gap-4">
          <button onClick={() => router.push('/coach/login')} className="font-roboto font-medium text-lg flex text-center bg-white text-blue-900 px-6 py-3 rounded-lg hover:opacity-90 transition-opacity shadow-lg">Coach Login</button>
          <button onClick={() => router.push('/athlete/login')} className="font-roboto font-medium text-lg flex text-center bg-white text-purple-900 px-6 py-3 rounded-lg hover:opacity-90 transition-opacity shadow-lg">Athlete Login</button>
        </div>
      </div>
        ...
        <div className="max-w-6xl w-full text-center">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-200">
            ...
            <div className="flex justify-center gap-6">
              <button onClick={() => router.push('/coach/login')} className="bg-gradient-to-r from-purple-900 to-blue-900 text-white px-8 py-4 rounded-lg font-medium hover:from-purple-800 hover:to-blue-800 hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-xl text-lg">
                I&apos;m a Coach
              </button>
              <button onClick={() => router.push('/athlete/login')} className="bg-gradient-to-r from-blue-900 to-purple-900 text-white px-8 py-4 rounded-lg font-medium hover:from-blue-800 hover:to-purple-800 hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-xl text-lg">
                I&apos;m an Athlete
              </button>
            </div>
          </div>
