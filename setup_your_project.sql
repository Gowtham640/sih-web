...
-- Run this in your Supabase SQL editor for project: ghpfvgtnaazrzkmsjpmy
...
-- Create policies for public access (you can tighten these later)
...
CREATE POLICY "Allow public read access on coach_athletes" ON coach_athletes FOR SELECT USING (true);
...
CREATE POLICY "Allow public insert on coach_athletes" ON coach_athletes FOR INSERT WITH CHECK (true);
...
CREATE POLICY "Allow public update on coaches" ON coaches FOR UPDATE USING (true);
